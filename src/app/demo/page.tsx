...
export default function DemoPage() {
  ...
  const totalVolume = DEMO_AFFILIATE.referred_volume_total;
  ...
  const transactedCount = users.filter((u) => TRANSACTED_SLUGS.includes(u.status_slug)).length;

  return (
    <>
      {/* Hero Greeting (Demo Mode badge preserved) */}
